...
class ContractsTest < ApplicationSystemTestCase
  ...
  test "creating a Contract" do
    ...
    fill_in "Accountid", with: @contract.accountid
    fill_in "Contractnumber", with: @contract.contractnumber
    fill_in "Contractterm", with: @contract.contractterm
    fill_in "Sfid", with: @contract.sfid
    fill_in "Startdate", with: @contract.startdate
